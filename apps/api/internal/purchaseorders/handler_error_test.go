...
func TestHandler_ErrorPaths(t *testing.T) {
	...
	cases := []struct {
		...
		{"list", http.MethodGet, "/purchase-orders/", nil, http.StatusInternalServerError},
		{"get", http.MethodGet, "/purchase-orders/1", nil, http.StatusInternalServerError},
		{"get_by_quotation", http.MethodGet, "/purchase-orders/by-quotation/1", nil, http.StatusInternalServerError},
