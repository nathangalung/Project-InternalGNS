...
-- PO direct edit endpoint
-- Replaces po_items wholesale, updates header discount and notes.
-- Locked when status = DELIVERED (invoice exists).
...
DROP FUNCTION IF EXISTS fn_update_po_items(BIGINT, BIGINT, NUMERIC, TEXT, TEXT, INT, NUMERIC, JSONB);
