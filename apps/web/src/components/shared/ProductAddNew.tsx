...
export interface ProductAddNewData {
  nama: string;
  kode: string;
  satuan: string;
  aktif: boolean;
...
interface ProductAddNewProps {
  ...
  onSuccess?: (data: ProductAddNewData) => void;
}
...
export default function ProductAddNew({ open, onOpenChange, onSuccess }: ProductAddNewProps) {
