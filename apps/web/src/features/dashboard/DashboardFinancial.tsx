...
export default function DashboardFinancial({
  ...
  return (
    <div className="admin-shell">
      <Sidebar activePage={"dashboard-financial" as Page} onNavigate={onNavigate} onLogout={onLogout} />
            ...
            <table className="tbl">
              ...
              <tbody>
                {recentInvoices.length === 0 && (
                  <tr>
                    <td colSpan={6} className="tbl-td tbl-td--center" style={{ padding: "40px 0", color: "#64748B" }}>
                      Belum ada Invoice.
                    </td>
                  </tr>
                )}
