  ...
  return (
    <div className="summary-cards">
      <div className="card-violet">
        ...
        <div className="card-value">{total.toLocaleString("id-ID")}</div>
      </div>
      <div className="card-gold">
        ...
        <div className="card-value">{draft.toLocaleString("id-ID")}</div>
      </div>
