...
export default function LegalCard({ form, onChange, isNamaKontakFilled }: LegalCardProps) {
  return (
    <div
      ...
      style={{ opacity: !isNamaKontakFilled ? 0.6 : 1, transition: "opacity 0.2s ease" }}
    >
      <div className="ca-section-heading">Legalitas</div>
      <div className="ca-row-2">
        <div className="ca-field">
          <label className="ca-label">
            NPWP <span className="ca-optional">(Opsional)</span>
          </label>
          <input
            className="ca-input"
            type="text"
        ...
        <div className="ca-field">
          <label className="ca-label">
            TKU <span className="ca-optional">(Opsional)</span>
          </label>
          <input
            className="ca-input"
            type="text"
      ...
      <div className="ca-field">
        <label className="ca-label">
          Reference Number <span className="ca-optional">(Opsional)</span>
        </label>
        <input
          className="ca-input"
          type="text"
