...
export default function PurchaseOrderFilter({ onClose, onApply, initialValues }: PurchaseOrderFilterProps) {
  ...
  const [activeStatuses, setActiveStatuses] = useState<PoStatus[]>(initialValues?.statuses ?? DEFAULTS.statuses)
