...
const SCOPE: Record<CompletenessIssue["kind"], string> = { client: "Klien", vendor: "Vendor" }

// Server-reported gaps before Dalam Progres.
export default function CompletenessModal({ issues, onClose }: CompletenessModalProps) {
  return (
    <Modal
    ...
    >
      <p className="m-0 text-[13px] leading-[1.5] text-[#4A4455]">
        ...
        data berikut harus dilengkapi terlebih dahulu. Buka nama klien atau vendor untuk
        melengkapinya.
      </p>
