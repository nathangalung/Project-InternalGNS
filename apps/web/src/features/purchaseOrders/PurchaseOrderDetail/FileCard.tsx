...
export default function FileCard({ fileName, fileSize, uploadedAt, onUpload, onDownload }: FileCardProps) {
  const hasFile = Boolean(fileName)

  return (
    <div>
      <h2 className="qe-section-title" style={{ marginBottom: "12px" }}>Berkas Purchase Order</h2>
      <div style={{
        background: "#FFFFFF",
        ...
        <div style={{
          ...
          <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke={hasFile ? "#630ED4" : "#94A3B8"} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
