...
export default function UserDetail({ user, onNavigate, onBack, onLogout }: UserDetailProps) {
  ...
  const handleSubmit = async () => {
    ...
    if (password.length > 0 && !passwordIsValid(password)) errs.password = "Kata sandi belum memenuhi semua aturan"
        ...
        <div className="page-content" style={{ gap: "29px" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "20px" }}>
              ...
              <h1 className="page-title" style={{ margin: 0 }}>Detail Pengguna</h1>
            </div>
          </div>
            ...
            <div style={{
              ...
              <div style={{
                ...
                <svg width="64" height="64" viewBox="0 0 64 64" fill="none">
                  ...
                  <path d="M12 56 C12 44, 21 39, 32 39 C43 39, 52 44, 52 56 L52 60 C52 62, 50 64, 48 64 L16 64 C14 64, 12 62, 12 60 Z" fill="#191C1E" />
                </svg>
              </div>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "24px 32px" }}>
                ...
                <div>
                  ...
                  <input
                    ...
                    style={{ ...inputStyle, borderColor: fieldErrors.email ? "#DC2626" : "transparent" }}
                  />
                  {fieldErrors.email && <div style={{ marginTop: "6px", fontSize: "12px", color: "#DC2626", fontFamily: "'Inter', sans-serif" }}>{fieldErrors.email}</div>}
                </div>
                ...
                <div>
                  ...
                  <div style={{ position: "relative" }}>
                    <input
                      ...
                      style={{ ...inputStyle, paddingRight: "48px", borderColor: fieldErrors.password ? "#DC2626" : "transparent" }}
                    />
                    <button
                      type="button"
                    ...
                    >
                      {showPwd ? (
                        <svg width="20" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
                  ...
                  {fieldErrors.password && <div style={{ marginTop: "6px", fontSize: "12px", color: "#DC2626", fontFamily: "'Inter', sans-serif" }}>{fieldErrors.password}</div>}
