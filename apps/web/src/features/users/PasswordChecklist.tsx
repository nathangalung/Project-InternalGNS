      ...
      <ul style={{
        ...
        {PASSWORD_RULES.map(rule => {
          ...
          return (
            ...
            >
              {ok ? (
                <svg width="12" height="12" viewBox="0 0 14 11" fill="none" style={{ flexShrink: 0 }}>
                  <path d="M1 5.5L4.5 9L13 1" stroke="#10B981" strokeWidth="2.4" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
              ) : (
                <svg width="12" height="12" viewBox="0 0 14 14" fill="none" style={{ flexShrink: 0 }}>
                  <line x1="3" y1="7" x2="11" y2="7" stroke="#CBD5E1" strokeWidth="2" strokeLinecap="round" />
                </svg>
              )}
              {rule.label}
            </li>
