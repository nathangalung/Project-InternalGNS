...
export default function VendorAddModal({ open, onOpenChange, onSuccess, nested = false }: VendorAddModalProps) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const msg = err instanceof ApiError ? (err.message || "Gagal menyimpan vendor.") : "Gagal menyimpan vendor."
      setSubmitError(msg)
    }
  }
      ...
      <div className="ca-modal" onClick={e => e.stopPropagation()}>
        ...
        <div className="ca-body">
          ...
          <div className="ca-section">
            ...
            <div className="ca-field">
              <label className="ca-label">SKU Vendor <span className="ca-optional">(Opsional)</span></label>
              <input
                className="ca-input"
                type="text"
          ...
          <div className="ca-section" style={{ opacity: !isAddressFilled ? 0.6 : 1, transition: "opacity 0.2s ease" }}>
        ...
        <div className="ca-footer" style={{ padding: "16px 24px" }}>
          ...
          {!submitError && isAddressFilled && !isContactValid && (
            <span style={{ fontSize: "12px", color: "#EF4444", flex: 1 }}>Isi minimal email atau nomor telepon.</span>
          )}
          <button
            type="button"
