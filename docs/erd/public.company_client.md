...
| number          | varchar(10)              | fn_next_client_number()                    | false    |                                                                                                                                                                                                                                           |                                         |                                                                       |
...
| company_client_number_format_check | CHECK       | CHECK (((number)::text ~ '^[0-9]{4}$'::text))                            |
| company_client_number_not_null     | n           | NOT NULL number                                                          |
...
| uq_company_client_number     | CREATE UNIQUE INDEX uq_company_client_number ON public.company_client USING btree (number)       |
